...
use BundleProduct\Service\CustomFieldsInstaller;

class BundleProduct extends Plugin
{
    ...
    private function getCustomFieldsInstaller()
    {
    ...
    {
        return "BundleProduct\Migration";
    }
}
